package com.mobatia.naisapp.fragments.gallery.adapter;
 ...
 */
public class GalleryVideoRecyclerviewAdapter extends RecyclerView.Adapter<GalleryVideoRecyclerviewAdapter.MyViewHolder> {
    ...
    public GalleryVideoRecyclerviewAdapter(Context mContext, ArrayList<PhotosListModel> mPhotosList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.gallery_thumbnail_video_recyclerview_adapter, parent, false);
