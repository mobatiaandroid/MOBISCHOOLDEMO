 ...
 */
public class CustomStaffDirectoryAdapter extends RecyclerView.Adapter<CustomStaffDirectoryAdapter.MyViewHolder> {
	...
	public CustomStaffDirectoryAdapter(Context mContext,ArrayList<StaffModel> mStaffList) {
