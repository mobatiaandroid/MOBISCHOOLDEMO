 ...
 */
public class PTAinfoActivity  extends Activity implements IntentPassValueConstants, NaisClassNameConstants{
    private ImageView mImgCircle[];
    private LinearLayout mLinearLayout;
    ViewPager mTutorialViewPager;
    Context mContext;
    TutorialViewPagerAdapter mTutorialViewPagerAdapter;
    ArrayList<Integer> mPhotoList = new ArrayList<>(Arrays.asList(R.drawable.tut_pa_1, R.drawable.tut_pa_2, R.drawable.tut_pa_3, R.drawable.tut_pa_4, R.drawable.tut_pa_5, R.drawable.tut_pa_6));
    int dataType;
    ImageView imageSkip;
    String mStaffid;
    String mStudentId;
