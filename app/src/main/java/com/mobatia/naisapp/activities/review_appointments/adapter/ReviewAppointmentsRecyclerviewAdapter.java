package com.mobatia.naisapp.activities.review_appointments.adapter;
...
//        setHasStableIds(false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (!(mVideosModelArrayList.get(position).getBook_end_date().trim().equalsIgnoreCase(""))) {
            holder.expireDateTimeTextView.setText("Confirm/Cancellation closes at " + AppUtils.dateParsingToDdMmmYyyy(mVideosModelArrayList.get(position).getBook_end_date()));
        } else {
