package com.mobatia.naisapp.activities.class_representative.adapter;
 ...
 */
public class ClassRepresentativeRecyclerAdapter extends RecyclerView.Adapter<ClassRepresentativeRecyclerAdapter.MyViewHolder> {
    ...
    public ClassRepresentativeRecyclerAdapter(Context mContext, ArrayList<TermsCalendarModel> mnNewsLetterModelArrayList) {
