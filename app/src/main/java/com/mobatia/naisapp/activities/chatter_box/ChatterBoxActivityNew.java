...
import com.mobatia.naisapp.activities.chatter_box.adapter.ChatterBoxRecyclerAdapterNew;
...
//				LoginActivity.class));
    ...
    public void onClick(View v) {
        ...
        mChatterBoxListRecyclerView.addItemDecoration(new DividerItemDecoration(getResources().getDrawable(R.drawable.list_divider)));
                                ...
                                if (responsCode.equals(RESPONSE_SUCCESS)) {
                                    ...
                                    if (statusCode.equals(STATUS_SUCCESS)) {
                                        ...
                                        if (!bannerImage.equalsIgnoreCase("")) {
                                            Glide.with(mContext).load(AppUtils.replace(bannerImage)).placeholder(R.drawable.default_banner).centerCrop().into(bannerImagePager);
