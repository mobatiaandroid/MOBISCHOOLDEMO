...
public class PaymentCategoryListActivity extends Activity implements JSONConstants,ResultConstants,StatusConstants,URLConstants
{
                    ...
                    if (response_code.equalsIgnoreCase("200")) {
                        ...
                        if (status_code.equalsIgnoreCase("303")) {
                            ...
                            if (data.length() > 0) {
                                ...
                                Toast.makeText(PaymentCategoryListActivity.this, "No data found", Toast.LENGTH_SHORT).show();
                            }
                        }
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(PaymentCategoryListActivity.this, tab_type);
        ...
        mNewsLetterListView.addOnItemTouchListener(new RecyclerItemListener(getApplicationContext(), mNewsLetterListView,
                new RecyclerItemListener.RecyclerTouchListener() {
                    public void onClickItem(View v, int position) {
                        Intent intent= new Intent(PaymentCategoryListActivity.this,TripsDetailActivity.class);
