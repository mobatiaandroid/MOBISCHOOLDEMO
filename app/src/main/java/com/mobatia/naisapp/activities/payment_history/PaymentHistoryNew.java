...
public class PaymentHistoryNew extends Activity implements URLConstants, JSONConstants, NaisClassNameConstants {
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(PaymentHistoryNew.this, "Payment History");
        ...
        if (AppUtils.isNetworkConnected(mContext)) {
            getEventsListApi(URL_CANTEEN_WALLET_HISTORY,studentIdStr);
        } else {
        ...
        PreferenceManager.setCanteenStudentId(mContext, studentIdStr);
        ...
        socialMediaList.addOnItemTouchListener(new RecyclerItemListener(mContext, socialMediaList,
                new RecyclerItemListener.RecyclerTouchListener() {
                    public void onClickItem(View v, int position) {
                        ...
                        if (AppUtils.isNetworkConnected(mContext)) {
                            getEventsListApi(URL_CANTEEN_WALLET_HISTORY,PreferenceManager.getCanteenStudentId(mContext));
                        } else {
                            AppUtils.showDialogAlertDismiss((Activity) mContext, "Network Error", getString(R.string.no_internet), R.drawable.nonetworkicon, R.drawable.roundred);
