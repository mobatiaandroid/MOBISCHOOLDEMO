package com.mobatia.naisapp.activities.notification_new;
 ...
 */
public class AudioPlayerViewActivityNew extends Activity implements IntentPassValueConstants, JSONConstants, URLConstants, StatusConstants {
    Bundle extras;
    String url;
    Context mContext;
...
//UtilityMethods.showAlertFinish(activity,"Can't play this video","","OK",false);
    ...
    private void callPushNotification(String pushID)
    {
        try {
            ...
            String[] name = {JTAG_ACCESSTOKEN,"push_id","users_id"};
            String[] value = {PreferenceManager.getAccessToken(mContext),pushID,PreferenceManager.getUserId(mContext)};
