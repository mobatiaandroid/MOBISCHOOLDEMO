package com.mobatia.naisapp.activities.sports.information;
...
public class InformationActivity extends Activity
    ...
    InformationRecyclerAdapter customStaffDirectoryAdapter;
                                ...
                                if (responsCode.equals(RESPONSE_SUCCESS)) {
                                    ...
                                    if (statusCode.equals(STATUS_SUCCESS)) {
                                        ...
                                        if (dataArray.length() > 0) {
                                            ...
                                            customStaffDirectoryAdapter = new InformationRecyclerAdapter(mContext, mListViewArray);
...
//								CustomStatusDialog(RESPONSE_FAILURE);
    ...
    private SecondaryModel getSearchValues(JSONObject Object)
        ...
        mSecondaryModel.setId(Object.getString("id"));
