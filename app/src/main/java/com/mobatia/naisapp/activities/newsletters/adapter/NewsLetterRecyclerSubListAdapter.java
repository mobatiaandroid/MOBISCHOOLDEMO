 ...
 */
public class NewsLetterRecyclerSubListAdapter extends RecyclerView.Adapter<NewsLetterRecyclerSubListAdapter.MyViewHolder> {
    ...
    public NewsLetterRecyclerSubListAdapter(Context mContext,ArrayList<NewsLetterModel> mnNewsLetterModelArrayList) {
