...
public class CartDateRecyclerAdapter extends RecyclerView.Adapter<CartDateRecyclerAdapter.MyViewHolder> {
    ...
    public CartDateRecyclerAdapter(Context mContext, ArrayList<CartItemDateModel> mCartDateArrayList,String ordered_user_type,String student_id,String parent_id,String staff_id) {
    ...
    @Override
    public CartDateRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_cart_date_recycler, parent, false);

        return new CartDateRecyclerAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final CartDateRecyclerAdapter.MyViewHolder holder, int position) {
