...
internal class NumericMaskInputFilter(
    ...
    private fun appendEnd(builder: StringBuilder, @androidx.annotation.IntRange(from = 0) start: Int, source: CharSequence): Int {
        var next = start
        source.forEach { chr ->
    ...
    private fun appendEnd(builder: StringBuilder, @androidx.annotation.IntRange(from = 0) start: Int, chr: Char): Int {
    ...
    private fun isMaskChar(@androidx.annotation.IntRange(from = 0) index: Int): Boolean {
    ...
    internal interface MaskListener {
        fun onNewText(rawTextValue: String, maskedTextValue: String, @androidx.annotation.IntRange(from = 0) cursorPosition: Int)
    }
